...
<form action="{{ route('bank.index') }}" method="GET" class="mb-3">
    <div class="row g-2 align-items-end">
        ...
        <div class="col-md-2">
            <div class="row g-1">
                ...
                <div class="col-6">
                    <a href="{{ route('bank.index') }}" class="btn btn-secondary w-100">
                        Reset
                    </a>
                </div>
            </div>
...
{!! $bank->appends(request()->query())->links('pagination::bootstrap-5') !!}
