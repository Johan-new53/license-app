...
<form action="/searchname/" method="get">
    ...
    <div class="col-lg-8 margin-tb d-flex justify-content-between align-items-center mb-3 ">
        ...
        <input type="search" name="searchname" class="form-control @error('id_unit') is-invalid @enderror">
        <br>
    ...
    <tr>
        ...
        <td>
             ...
             <a class="btn btn-primary btn-sm" href="{{ route('users.edit',$user->id) }}">
              ...
              <form method="POST" action="{{ route('users.destroy', $user->id) }}" onsubmit="return confirmDelete();" style="display:inline">
                  @csrf
                  @method('DELETE')
