    ...
    <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade p-3" id="quantity" role="tabpanel" aria-labelledby="quantity-tab">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Used:</strong>
                    <input type="text" name="used" class="form-control" placeholder="Used">
                </div>
            </div>
            <br>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="remaining" class="form-control" placeholder="Remaining">
                </div>
            </div>
            <br>
        </div>
        <div class="tab-pane fade p-3" id="renewal" role="tabpanel" aria-labelledby="renewal-tab">
            <div class="col-xs-2 col-sm-2 col-md-2 ">
                <div class="form-group">
                    ...
                    <input type="date" name="start_date" value="1900-01-01" class="form-control" placeholder="Start date">
                </div>
            </div>
            <br>
            <div class="col-xs-2 col-sm-2 col-md-2">
                <div class="form-group">
                    ...
                    <input type="date" name="end_date" value="1900-01-01" class="form-control" placeholder="End date">
                </div>
            </div>
            <br>
            <div class="col-xs-2 col-sm-2 col-md-2">
                <div class="form-group">
                    ...
                    <input type="date" name="last_bidding" value="1900-01-01" class="form-control" placeholder="Last bidding">                    
                </div>
            </div>
            <br>
            <div class="col-xs-2 col-sm-2 col-md-2">
                <div class="form-group">
                    ...
                    <input type="date" name="next_bidding" value="1900-01-01" class="form-control" placeholder="Next bidding">
                </div>
            </div>
            <br>
            <div class="col-xs-2 col-sm-2 col-md-2">
                <div class="form-group">
                    ...
                    <input type="date" name="renewal_date" value="1900-01-01" class="form-control" placeholder="Renewal date">
                </div>
            </div>
            <br>
        </div>
        ...
        <div class="tab-pane fade p-3" id="email" role="tabpanel" aria-labelledby="email-tab">
            <div class="col-xs-2 col-sm-2 col-md-2 ">
                <div class="form-group">
                    ...
                    <input type="date" name="tgl_email1" value="1900-01-01" class="form-control" placeholder="tgl_email1">
                </div>
            </div>
            <br>
            <div class="col-xs-2 col-sm-2 col-md-2">
                <div class="form-group">
                    ...
                    <input type="date" name="tgl_email2" value="1900-01-01" class="form-control" placeholder="tgl_email2">
                </div>
            </div>
            <br>
            <div class="col-xs-2 col-sm-2 col-md-2">
                <div class="form-group">
                    ...
                    <input type="date" name="tgl_email3" value="1900-01-01" class="form-control" placeholder="tgl_email3">
                </div>
            </div>
            <br>
             <div class="col-xs-2 col-sm-2 col-md-2">
                <div class="form-group">
                    ...
                    <input type="date" name="request_date" value="1900-01-01" class="form-control" placeholder="request_date">
                </div>
            </div>
            <br>
        </div>
         ...
         <div class="tab-pane fade p-3" id="vendor" role="tabpanel" aria-labelledby="vendor-tab">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="mata_uang" class="form-control" placeholder="Rp or Usd">
                </div>
            </div>
            <br>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="amount_excl_vat" class="form-control" placeholder="0">
                </div>
            </div>
            <br>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Pr:</strong>
                    <input type="text" name="pr" class="form-control" placeholder="pr">
                </div>
            </div>
            <br>
             <div class="col-xs-12 col-sm-12 col-md-12">
        ...
        <div class="tab-pane fade p-3" id="pic" role="tabpanel" aria-labelledby="pic-tab">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="email" name="mail_pic" class="form-control" placeholder="mail_pic">
                </div>
            </div>
            <br>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="hp_pic" class="form-control" placeholder="hp_pic">
                </div>
            </div>
         ...
         <div class="tab-pane fade p-3" id="status" role="tabpanel" aria-labelledby="status-tab">
            ...
            <div class="col-xs-2 col-sm-2 col-md-2">
                <div class="form-group">
                    ...
                    <input type="date" name="date_update_status" value="1900-01-01" class="form-control" placeholder="date_update_status">
                </div>
            </div>
            <br>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="no_tiket" class="form-control" placeholder="no_tiket">
                </div>
            </div>
             <br>
            <div class="col-xs-12 col-sm-12 col-md-12">
        ...
        <div class="tab-pane fade p-3" id="admin" role="tabpanel" aria-labelledby="admin-tab">
            <div class="col-xs-12 col-sm-12 col-md-12 ">
                <div class="form-group">
                    ...
                    <input type="text" name="nama_admin" class="form-control" placeholder="Nama">
                </div>
            </div>
            <br>
            <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="hp_admin" class="form-control" placeholder="No Hp">
                </div>
            </div>
