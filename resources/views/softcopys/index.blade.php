    ...
    <table class="table table-bordered">
        ...
        <tr class="align-middle">
            ...
            <td class="text-center" style="white-space:nowrap;">
                {{ $softcopy->invoice_date ? \Carbon\Carbon::parse($softcopy->invoice_date)->format('d-m-Y') : '-' }}
            </td>
            ...
            <td class="text-center" style="white-space:nowrap;">
                @php
                    $statusClass = match(strtolower($softcopy->status ?? '')) {
                ...
                @endphp
                <span class="badge {{ $statusClass }}">{{ $softcopy->status }}</span>
            </td>
            <td class="text-center" style="white-space:nowrap;">
                <strong>Due</strong><br>
                {{ in_array($softcopy->status, ['approved 2', 'paid']) && $softcopy->due_date ? \Carbon\Carbon::parse($softcopy->due_date)->format('d-m-Y') : '-' }}<br>
                <strong>Paid</strong><br>
                {{ $softcopy->payment_date ? \Carbon\Carbon::parse($softcopy->payment_date)->format('d-m-Y') : '-' }}
            </td>
