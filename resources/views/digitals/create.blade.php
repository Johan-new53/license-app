...
<form action="{{ route('digitals.store') }}" method="POST" novalidate>
    @csrf
        ...
        <div class="tab-pane fade p-3" id="data3" role="tabpanel" aria-labelledby="data3-tab">
            ...
            <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="nama_rekening_tujuan" value="{{ old('nama_rekening_tujuan') }}" class="form-control" placeholder="Nama Rekening Tujuan" required>
                </div>
            </div>
            <br>
            <div class="col-xs-4 col-sm-4 col-md-4">
        ...
        <div class="tab-pane fade p-3" id="data4" role="tabpanel" aria-labelledby="data4-tab">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="activity_code" value="{{ old('activity_code') }}" class="form-control" placeholder="" required>
                </div>
            </div>
            <br>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="journal_no" value="{{ old('journal_no') }}" class="form-control" placeholder="" required>
                </div>
            </div>
            <br>
