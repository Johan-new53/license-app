        ...
        <div class="tab-pane fade show active p-3" id="data1" role="tabpanel" aria-labelledby="data1-tab">
            ...
            <div class="col-xs-2 col-sm-2 col-md-2 ">
                <div class="form-group">
                    ...
                    <input type="date" name="form_submission_time" value="{{ old('form_submission_time', date('Y-m-d')) }}" class="form-control" placeholder="" required>
                </div>
            </div>
            <br/>
            <div class="col-xs-2 col-sm-2 col-md-2 ">
                <div class="form-group">
                    ...
                    <input type="date" name="final_validation_time" value="{{ old('final_validation_time', date('Y-m-d')) }}" class="form-control" placeholder="" required>
                </div>
            </div>
            <br/>
            <div class="col-xs-12 col-sm-12 col-md-12">
        ...
        <div class="tab-pane fade p-3" id="data3" role="tabpanel" aria-labelledby="data3-tab">
            ...
            <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="nama_rekening_tujuan" value="{{ old('nama_rekening_tujuan') }}" class="form-control" placeholder="" required>
                </div>
            </div>
            <br>
            <div class="col-xs-4 col-sm-4 col-md-4">
                        ...
                        <select name="id_bank" class="form-control select2" required>
                            ...
                            @foreach ($banks as $bank)
                                <option value="{{ $bank->id }}" {{ old('id_bank') == $bank->id ? 'selected' : '' }}>
                                    {{ $bank->nama }}
                                </option>
                            @endforeach
                        </select>
            ...
            <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="no_rek_tujuan" value="{{ old('no_rek_tujuan') }}" class="form-control" placeholder="" required>
                </div>
            </div>
            <br>
        ...
        <div class="tab-pane fade p-3" id="data4" role="tabpanel" aria-labelledby="data4-tab">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="journal_no" value="{{ old('journal_no') }}" class="form-control" placeholder="">
                </div>
            </div>
            <br>
        </div>
