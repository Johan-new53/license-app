...
<div class="row mb-3">
    <div class="col-lg-12">
        <div style="display:flex; justify-content:space-between; align-items:center;">
            ...
            <div>
                <a class="btn btn-primary btn-sm" href="{{ route('automates.index') }}">Back</a>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            {{ $finance->form_submission_time ? \Carbon\Carbon::parse($finance->form_submission_time)->format('d-M-Y') : '-' }}
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <strong>Final Validation Time :</strong>
                            {{ $finance->final_validation_time ? \Carbon\Carbon::parse($finance->final_validation_time)->format('d-M-Y') : '-' }}
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
