...
<div class="row">
    <div class="col-lg-12 margin-tb">
        ...
        <div class="pull-right">
            <a class="btn btn-primary" href="{{ route('automates.index') }}">Back</a>
        </div>
    </div>
</div>
...
<div class="col-md-6">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            ...
            {{ \Carbon\Carbon::parse($finance->form_submission_time)->format('d-M-Y') }}
        </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            <strong>Final Validation Time :</strong>
            {{ \Carbon\Carbon::parse($finance->final_validation_time)->format('d-M-Y') }}
        </div>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
