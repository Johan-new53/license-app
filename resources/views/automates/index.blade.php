...
<form action="{{ route('automates.index') }}" method="GET" class="mb-3">
    <div class="row g-2 align-items-end">
        ...
        <div class="col-lg-2">
            ...
            <div class="row g-1 mb-0">
                ...
                <div class="col-2">
                    <a href="{{ route('automates.index') }}" class="btn btn-secondary w-100">
                        Reset
                    </a>
                </div>
            </div>
            ...
            <td>
                <form action="{{ route('automates.destroy',$automate->id) }}" method="POST"
                    ...
                    <a class="btn btn-info btn-sm"
                       href="{{ route('automates.show',$automate->id) }}">
